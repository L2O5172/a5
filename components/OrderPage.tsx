...
export const OrderPage: React.FC<OrderPageProps> = ({ menuItems, onSubmitOrder, showNotification, onViewHistory }) => {
    ...
    useEffect(() => {
        ...
        if (minutes === 0) now.setHours(hours + 1);
    ...
    const validateForm = () => {
        ...
        if (cart.length === 0) {
            if (isValid) showNotification('請至少選擇一個餐點', 'error'); // Only show if other fields are valid
            isValid = false;
        }
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            // Error is handled by the parent component's showNotification
        } finally {
            setIsLoading(false);
        }
    };
        ...
        <div className="animate-fade-in">
            ...
            <div className="space-y-4 mt-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                 ...
                 {timeError && <p className="text-red-500 text-xs -mt-3 ml-1">{timeError}</p>}
